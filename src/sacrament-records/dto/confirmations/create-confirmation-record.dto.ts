...
export class CreateConfirmationRecordDto {
  ...
  @ApiProperty({
    description: 'Fecha de la confirmación.',
    format: 'date-time',
  })
  @IsString()
  date!: string;
  ...
  @ApiProperty({
    description: 'Lugar de la confirmación.',
  ...
  @ApiProperty({
    description: 'Identificador de la persona confirmada.',
